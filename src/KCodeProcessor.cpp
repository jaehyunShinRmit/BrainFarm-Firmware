...
KCodeHandler *KCodeProcessor::getKCodeHandler(CommandCodeEnum codeEnum)
{
  ...
  if (codeEnum == K17)
  {
    handler = K17Handler::getInstance();
  }
  if (codeEnum == K51)
  {
  ...
  if (codeEnum == K61)
  {
    handler = K61Handler::getInstance();
  }
  if (codeEnum == K62)
  {
    handler = K62Handler::getInstance();
  }
  if (codeEnum == K63)
  {
    handler = K63Handler::getInstance();
  }
  if (codeEnum == K70)
  {
    handler = K70Handler::getInstance();
  }
    if (codeEnum == K71)
  {
    handler = K71Handler::getInstance();
  }
    if (codeEnum == K72)
  {
    handler = K72Handler::getInstance();
  }
    if (codeEnum == K73)
  {
    handler = K73Handler::getInstance();
  }
    if (codeEnum == K74)
  {
    handler = K74Handler::getInstance();
  }
    if (codeEnum == K75)
  {
    handler = K75Handler::getInstance();
  }
    if (codeEnum == K76)
  {
    handler = K76Handler::getInstance();
  }
    if (codeEnum == K77)
  {
    handler = K77Handler::getInstance();
  }
    if (codeEnum == K78)
  {
    handler = K78Handler::getInstance();
  }
    if (codeEnum == K79)
  {
    handler = K79Handler::getInstance();
  }
